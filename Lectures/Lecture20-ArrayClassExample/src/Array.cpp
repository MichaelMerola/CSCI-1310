...
/*Overwrite the existing value for an index. The value
needs to be within the region that is occupied with
good data.*/
void Array::updateData(int index, int value){
    if(index < currentIndex)
        arrayData[index] = value;
    else
        cout<<"index not valid or out of bounds"<<endl;
}
