...
String Methods:
Strings are fun to play with because there is lots of functionality
built into python for working with strings. For example, there is a 
method called "find" that can be used to find a given item in the 
string. The method will produce a value that is the index of where that
item was found. The syntax looks like:
'''
i = DNA.find("CAA")
